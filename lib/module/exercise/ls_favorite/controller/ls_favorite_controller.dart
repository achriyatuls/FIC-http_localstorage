...
class LsFavoriteController extends State<LsFavoriteView>
  ...
  addToFavorite(Map item) {
    ...
    */
    // jawaban nomer 4
    //item["favorite"] = !item["favorite"]; awalnya.
    // alasan
    // ketika running warning mengatakan null bukan tipe data bolean.
    //untuk handle null nya perlu ditambahkan "?? flase".
    //setting false akan dijadikan settingan default
    // perbaikan
    item["favorite"] = !(item["favorite"] ?? false);

    // atau bisa

    // item['favorite'] = item["favorite"] = !item["favorite"];
    // ini menggunakan logika button
